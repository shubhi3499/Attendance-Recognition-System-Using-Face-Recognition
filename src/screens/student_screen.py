...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name",placeholder='E.g.Jonny')
            ...
            try:
                audio_input = st.audio_input('Record a short phrase like I am present,My Name is Rahul')
            except Exception:
                ...
                if new_name:
                    with st.spinner('Creating Profile ..'):
                        ...
                        if encodings:
                            ...
                            st.error("Couldnt capture your facial features for registartaion")
                else:
